  ...
  return (
    <div id="header" className="topnav">
      ...
      <div className="dropdown">
        <a
          href="#"
          onClick={() => router.push(`${baseUrl}planificateur/`)}
        ...
        <div className="dropdown-content">
          <a
            href="#"
            onClick={() => router.push(`${baseUrl}planificateur/ou_voler/`)}
            style={{ color: '#007BFF', fontWeight: 'bold' }}
          >
            Ou voler ?
          </a>
      ...
      <div className="dropdown">
        ...
        <div className="dropdown-content">
          <a
            href="#"
            onClick={() => router.push(`${baseUrl}passager/`)}
            style={{ color: '#007BFF', fontWeight: 'bold' }}
          >
            Passager
          </a>
          <a
            href="#"
            onClick={() => router.push(`${baseUrl}cargo/`)}
            style={{ color: '#007BFF', fontWeight: 'bold' }}
          >
            Cargo
          </a>
      ...
      <div className="dropdown">
        ...
        <div className="dropdown-content">
          <a
            href="#"
            onClick={() => router.push(`${baseUrl}database/avion/`)}
            style={{ color: '#007BFF', fontWeight: 'bold' }}
          >
            Avion
          </a>
